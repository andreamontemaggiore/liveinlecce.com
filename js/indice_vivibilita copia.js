      ...
      success: function(msg)
      {
        ...
        var tipo_struttura ="";
				 ...
				 if (jsonData.length > 0) {
                     ...
                     populate_social(raggio_scelto,strutture_trovate);
...
// *********************************************** POPOLA I DETTAGLI DELLA CATEGORIA SOCIAL
function populate_social(raggio_scelto,strutture_trovate) {
